...
```{r}
 ...
 avg_arr_del_wnames <- avg_arr_del |> left_join(airlines, by = "carrier")
...
### This difference in flight times is possible due to the size of aircraft at each of the different airlines, as well as whether they are carrying cargo or people. Bigger aircraft generally are able to fly faster but take longer to load. And cargo takes longer to load and offload compared to passengers. This means that the faster airlines could be in the business of large passenger planes while slower airlines are using small cargo planes.

## Question 7

### Columns with typos:

#### 1. gender  - "femal" are the typo and should be "female"

#### 2. disease_status "Health" is the typo and should be "health"

### Columns with missing values:

#### 3. height and glucose both have missing values in the form of NA
